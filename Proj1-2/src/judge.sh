...
function run()
{
    ...
    diff ../results/DebugRun6.txt  ../validation/Validation6_PartB.txt
    if [ "${?}" == "0" ]
        then
            echo "OK"
    fi
    ...
    diff ../results/DebugRun7.txt  ../validation/Validation7_PartB.txt
    if [ "${?}" == "0" ]
        then
            echo "OK"
    fi
    ...
    diff ../results/DebugRun8.txt  ../validation/Validation8_PartB.txt
    if [ "${?}" == "0" ]
        then
            echo "OK"
    fi
    ...
    diff ../results/DebugRun9.txt  ../validation/Validation9_PartB.txt
    if [ "${?}" == "0" ]
        then
            echo "OK"
    fi
    ...
    diff ../results/DebugRun10.txt ../validation/Validation10_PartB.txt
    if [ "${?}" == "0" ]
        then
            echo "OK"
    fi
